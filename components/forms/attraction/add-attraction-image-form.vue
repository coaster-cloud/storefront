...
<template>
  ...
  >
    ...
    <date-input
      ...
      :violations="getFieldViolations('[addAttractionImages][0][date]')"
    />
    ...
    <select-input
      ...
      :violations="getFieldViolations('[addAttractionImages][0][license]')"
...
export default {
  ...
  methods: {
    async load () {
      ...
      const result = await me.$graphql('8e24eebf-1699-4028-8302-b51f536cfea7')
